...
function renderLog(){
  ...
  const filtered=logs.filter(l=>{
    ...
    if(fAction){
      const map={po:['buat_po','hapus_po','clone_po'],invv:['buat_invv','bayar_invv','edit_invv','konversi_pt','catat_cashback','catat_retur','catat_ongkir'],invd:['buat_invd','terima_invd','tambah_item_invd','merge_invd'],item:['edit_item','ganti_item','hapus_item','tambah_item','split_item'],kirim:['update_kirim']};
